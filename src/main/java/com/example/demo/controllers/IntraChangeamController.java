...
public class IntraChangeamController {
    ...
    public ResponseEntity<String> movePacket(@PathVariable(value = "packetId") String idPacket, @PathVariable(value = "deliveryId") String idDelivery, @RequestHeader(name = "Authorization") String authorizationHeader) {
    	try{
        ...
        String ville = (String) claims.get("agence");
    	String msg = "Paquet en provenance de l'agence : "+ville;
    	packageService.savePackage(P); 
    	notificationService.sendNotification(msg, Integer.toString(agency.getId()));
    ...
    public ResponseEntity<String> moveDeliveries(@PathVariable(value = "oldDeliv") String oldDeliv, @PathVariable(value = "deliveryId") String idDelivery, HttpSession session) {
    	...
    	for(String destination : destinations) {
        	...
        	notificationService.sendNotification(msg, Integer.toString(agencyService.findByVille(destination).getId()));
    	}
        // Return a 200 OK response
